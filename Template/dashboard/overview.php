<div class="bilgiyapar-mcc-dashboard-container">
    ...
    <div class="bilgiyapar-mcc-section">
        ...
        $kpi_groups = [
            'Genel Durum' => [
                ['title' => t('Genel Proje Performansı'), 'total' => '%'.$kpi['performance_avg'], 'sub' => '', 'color' => '#1a73e8', 'icon' => 'fa-line-chart', 'url' => $kpi['performance_avg'] > 0 ? $this->url->href('ExecutiveDashboardController', 'performance', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Proje Sağlığı'), 'total' => $kpi['health_status'], 'sub' => t('Durum'), 'color' => $kpi['health_color'], 'icon' => 'fa-heartbeat', 'url' => $this->url->href('ExecutiveDashboardController', 'health', ['plugin' => 'ExecutiveDashboard'])],
                ['title' => t('Genel Skor'), 'total' => '%'.$kpi['overall_score'], 'sub' => '', 'color' => '#f0ad4e', 'icon' => 'fa-trophy', 'url' => $kpi['overall_score'] > 0 ? $this->url->href('ExecutiveDashboardController', 'score', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Geciken Görevler'), 'total' => $kpi['overdue_total_count'], 'sub' => t('Dikkat Gerektiriyor'), 'color' => '#d73a49', 'icon' => 'fa-calendar-times-o', 'url' => $this->url->href('SearchController', 'index', array('search' => 'status:open due:<=today'))],
            ],
            'Projeler' => [
                ['title' => t('Projeler'), 'total' => $kpi['projects_active']+$kpi['projects_inactive'], 'sub' => t('Aktif').':'.$kpi['projects_active'].' '.t('Pasif').':'.$kpi['projects_inactive'], 'color' => '#0366d6', 'icon' => 'fa-folder-open-o', 'url' => $this->url->href('ProjectListController', 'show')],
                ['title' => t('Kişisel Projeler'), 'total' => $kpi['projects_private'], 'sub' => t('Gizli'), 'color' => '#0366d6', 'icon' => 'fa-lock', 'url' => $this->url->href('ProjectListController', 'show')],
                ['title' => t('Herkese Açık Projeler'), 'total' => $kpi['projects_public'], 'sub' => t('Genel'), 'color' => '#0366d6', 'icon' => 'fa-globe', 'url' => $this->url->href('ProjectListController', 'show')],
                ['title' => t('Görevler (Açık)'), 'total' => $kpi['tasks_active'], 'sub' => t('Aktif'), 'color' => '#e36209', 'icon' => 'fa-tasks', 'url' => $this->url->href('SearchController', 'index', array('search'=>'status:open'))],
                ['title' => t('Görevler (Kapalı)'), 'total' => $kpi['tasks_closed'], 'sub' => t('Tamamlanan'), 'color' => '#e36209', 'icon' => 'fa-check-square-o', 'url' => $this->url->href('SearchController', 'index', array('search'=>'status:closed'))],
            ],
            'Yapılandırma & Varlıklar' => [
                ['title' => t('Yorumlar'), 'total' => $kpi['comments'], 'sub' => '', 'color' => '#6f42c1', 'icon' => 'fa-comments', 'url' => $kpi['comments'] > 0 ? $this->url->href('ExecutiveDashboardController', 'comments', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Ekler'), 'total' => $kpi['attachments'], 'sub' => '', 'color' => '#6f42c1', 'icon' => 'fa-paperclip', 'url' => $kpi['attachments'] > 0 ? $this->url->href('ExecutiveDashboardController', 'attachments', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('External Links'), 'total' => $kpi['external_links'], 'sub' => '', 'color' => '#6f42c1', 'icon' => 'fa-external-link', 'url' => $kpi['external_links'] > 0 ? $this->url->href('ExecutiveDashboardController', 'externalLinks', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Etiketler'), 'total' => $kpi['tags'], 'sub' => '', 'color' => '#6f42c1', 'icon' => 'fa-tags', 'url' => $kpi['tags'] > 0 ? $this->url->href('ExecutiveDashboardController', 'tags', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Bağlantı Etiketleri'), 'total' => $kpi['link_labels'], 'sub' => '', 'color' => '#6f42c1', 'icon' => 'fa-link', 'url' => $kpi['link_labels'] > 0 ? $this->url->href('ExecutiveDashboardController', 'linkLabels', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Kategoriler'), 'total' => $kpi['categories'], 'sub' => '', 'color' => '#17a2b8', 'icon' => 'fa-tags', 'url' => $kpi['categories'] > 0 ? $this->url->href('ExecutiveDashboardController', 'categories', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Otomatik Eylemler'), 'total' => $kpi['auto_actions'], 'sub' => '', 'color' => '#17a2b8', 'icon' => 'fa-cogs', 'url' => $kpi['auto_actions'] > 0 ? $this->url->href('ExecutiveDashboardController', 'actions', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Templates'), 'total' => $kpi['templates'], 'sub' => '', 'color' => '#17a2b8', 'icon' => 'fa-file-text-o', 'url' => $kpi['templates'] > 0 ? $this->url->href('ExecutiveDashboardController', 'templates', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Task Templates'), 'total' => $kpi['task_templates'], 'sub' => '', 'color' => '#17a2b8', 'icon' => 'fa-file-text-o', 'url' => $kpi['task_templates'] > 0 ? $this->url->href('ExecutiveDashboardController', 'templates', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Yorum Şablonları'), 'total' => $kpi['comment_templates'], 'sub' => '', 'color' => '#17a2b8', 'icon' => 'fa-file-text-o', 'url' => $kpi['comment_templates'] > 0 ? $this->url->href('ExecutiveDashboardController', 'templates', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Genel Şablonlar'), 'total' => $kpi['general_templates'], 'sub' => '', 'color' => '#17a2b8', 'icon' => 'fa-file-text-o', 'url' => $kpi['general_templates'] > 0 ? $this->url->href('ExecutiveDashboardController', 'templates', ['plugin' => 'ExecutiveDashboard']) : ''],
            ],
            'Sistem' => [
                ['title' => t('Eklentiler'), 'total' => $kpi['plugins'], 'sub' => '', 'color' => '#28a745', 'icon' => 'fa-plug', 'url' => $this->url->href('PluginController', 'show')],
                ['title' => t('Saat Dilimleri'), 'total' => $kpi['timezones'], 'sub' => '', 'color' => '#d73a49', 'icon' => 'fa-clock-o', 'url' => $kpi['timezones'] > 0 ? $this->url->href('ExecutiveDashboardController', 'timezones', ['plugin' => 'ExecutiveDashboard']) : ''],
                ['title' => t('Diller'), 'total' => $kpi['languages'], 'sub' => '', 'color' => '#d73a49', 'icon' => 'fa-language', 'url' => $kpi['languages'] > 0 ? $this->url->href('ExecutiveDashboardController', 'languages', ['plugin' => 'ExecutiveDashboard']) : ''],
            ],
            'Kullanıcılar' => [
                ['title' => t('Kullanıcılar'), 'total' => $kpi['users_active']+$kpi['users_inactive'], 'sub' => t('Aktif').':'.$kpi['users_active'].' '.t('Pasif').':'.$kpi['users_inactive'], 'color' => '#d73a49', 'icon' => 'fa-user', 'url' => $this->url->href('UserListController', 'show')],
                ['title' => t('Standart Kullanıcı'), 'total' => $kpi['users_user'], 'sub' => t('Üye'), 'color' => '#d73a49', 'icon' => 'fa-user-o', 'url' => ''],
                ['title' => t('Yöneticiler'), 'total' => $kpi['users_manager'], 'sub' => t('PM'), 'color' => '#d73a49', 'icon' => 'fa-user-circle-o', 'url' => ''],
                ['title' => t('Sistem Yöneticileri'), 'total' => $kpi['users_admin'], 'sub' => t('Admin'), 'color' => '#d73a49', 'icon' => 'fa-user-secret', 'url' => $this->url->href('UserListController', 'show')],
                ['title' => t('Kullanıcı Grupları'), 'total' => $kpi['groups'], 'sub' => '', 'color' => '#d73a49', 'icon' => 'fa-users', 'url' => $this->url->href('GroupListController', 'index')],
            ],
        ];
        ?>
