...
class DemoImportController extends BaseController
{
    public function import()
    {
        ...
        // BAĞLANTILAR (1=relates to, 2=blocks, 3=is blocked by)
        ...
        echo "<p>Eski hatalı kopyalar temizlendi. Zaman takip formülleri, Alt görev sorumluları (user_id) ve Kritik Yol ağacınız kuruldu.</p>";
