...
class DemoImportController extends BaseController
{
    public function import()
    {
        ...
        echo "<p>Eski hatalı kopyalar temizlendi. RAW SQL Insert kullanılarak tüm eklenti kancaları es geçildi (user_id hatası %100 atlatıldı).</p>";
